...
const calcHumanAge = ages =>
  ages
    ...
    .filter(age => age >= 18)
    .reduce((acc, age, i, arr) => acc + Math.round(age / arr.length), 0);

console.log(calcHumanAge(testData1));
console.log(calcHumanAge(testData2));

const negativ = movements.find(mov => mov < 0);
console.log(negativ);
